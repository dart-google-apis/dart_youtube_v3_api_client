...
class ChannelSectionsResource_ {

  final Client _client;

  ChannelSectionsResource_(Client client) :
      _client = client;
   ...
   *
   * [request] - ChannelSection to send in this request
   *
   * [part] - The part parameter serves two purposes in this operation. It identifies the properties that the write operation will set as well as the properties that the API response will include.
...
This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<ChannelSection> insert(ChannelSection request, core.String part, {core.String onBehalfOfContentOwner, core.String onBehalfOfContentOwnerChannel, core.Map optParams}) {
    var url = "channelSections";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
    ...
    response = _client.request(url, "POST", body: request.toString(), urlParams: urlParams, queryParams: queryParams);
    return response
      .then((data) => new ChannelSection.fromJson(data));
  }
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a channelSection resource, the snippet property contains other properties, such as a display title for the channelSection. If you set part=snippet, the API response will also contain all of those nested properties.
   *
   * [channelId] - The channelId parameter specifies a YouTube channel ID. The API will only return that channel's channelSections.
   *
   * [id] - The id parameter specifies a comma-separated list of the YouTube channelSection ID(s) for the resource(s) that are being retrieved. In a channelSection resource, the id property specifies the YouTube channelSection ID.
   *
   * [mine] - Set this parameter's value to true to retrieve a feed of the authenticated user's channelSections.
   *
   * [onBehalfOfContentOwner] - Note: This parameter is intended exclusively for YouTube content partners.
...
The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user authenticates with must be linked to the specified YouTube content owner.
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<ChannelSectionListResponse> list(core.String part, {core.String channelId, core.String id, core.bool mine, core.String onBehalfOfContentOwner, core.Map optParams}) {
    var url = "channelSections";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
The part names that you can include in the parameter value are snippet and contentDetails.
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<ChannelSection> update(ChannelSection request, core.String part, {core.Map optParams}) {
    var url = "channelSections";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class I18nLanguagesResource_ {

  final Client _client;

  I18nLanguagesResource_(Client client) :
      _client = client;
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<I18nLanguageListResponse> list(core.String part, {core.String hl, core.Map optParams}) {
...
class I18nRegionsResource_ {

  final Client _client;

  I18nRegionsResource_(Client client) :
      _client = client;
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<I18nRegionListResponse> list(core.String part, {core.String hl, core.Map optParams}) {
    var url = "i18nRegions";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
